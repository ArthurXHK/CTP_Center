...
QUANTBOXC2CTP_API bool __stdcall TD_WaitForConnected(void *pTraderApi)
{
    if (pTraderApi)
    {
        if (TD_GetApi(pTraderApi)->WaitForConnected())
            return true;
    }
    return false;
...
//jebin
QUANTBOXC2CTP_API bool __stdcall MD_WaitForConnected(void *pMdUserApi)
{
    if (pMdUserApi)
    {
        if (MD_GetApi(pMdUserApi)->WaitForConnected())
            return true;
    }
    return false;
...
QUANTBOXC2CTP_API bool __stdcall TD_WaitForInstrumentGeted(void *pTraderApi)
{
    if (pTraderApi)
    {
        if (TD_GetApi(pTraderApi)->WaitForInstrumentGeted())
            return true;
    }
    return false;
}

...
{
    WaitForSingleObject(h_connected, 10000);
    return isconnected;
}

void CTraderApi::SetInstrumentGeted()
{
    SetEvent(h_instrumentGeted);
    isInstrumentGeted = true;
}

bool CTraderApi::WaitForInstrumentGeted()
{
    WaitForSingleObject(h_instrumentGeted, 10000);
